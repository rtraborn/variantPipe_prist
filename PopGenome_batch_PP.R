...
##########################################################################
vcfDir <- "/N/u/rtraborn/Carbonate/scratch/variantPipe/alignments/completed_vcfs"
myFile <- "/N/u/rtraborn/Carbonate/scratch/variantPipe/alignments/completed_vcfs/P_pacificus_strains.g.vcf"
##########################################################################
